...
$(document).ready(function() {
    ...
    $(document).ready(function() {
        $('.form-control').keyup(function(){ 
            ...
            Ploss_pv1f = data.Imp*Vdrop_pv1f
    ...
    $(document).ready(function() {
        $('.form-control').keyup(function(){
            cbdctotal =1.25*data.Isc*String_array*datain.Number_of_independent_MPP_inputs
...
var cbac
        ...
        $(document).ready(function() {
            $('.form-control').keyup(function(){ 
                wireac = $('#wireac').val()
                if(wireac == 'thw'){
                    if(Iac<=21){wireinv=2.5 ,vd=0.018}
                    else if(Iac >21 && Iac<=28){wireinv=4 ,vd=0.011}
                    else if(Iac >28 && Iac<=36){wireinv=6,vd=0.0073}
                    else if(Iac >36 && Iac<=50){wireinv=10,vd=0.0044}
                    else if(Iac >50 && Iac<=66){wireinv=16,vd=0.0028}
                    else if(Iac >66 && Iac<=88){wireinv=25,vd=0.00181}
                    else if(Iac >88 && Iac<=109){wireinv=35,vd=0.00133}
                    else if(Iac >109 && Iac<=131){wireinv=50,vd=0.001}
                    else if(Iac >131 && Iac<=167){wireinv=70,vd=0.00071}
                    else if(Iac >167 && Iac<=202){wireinv=95,vd=0.00056}
                    else if(Iac >202 && Iac<=234){wireinv=120,vd=0.00048}
                    else if(Iac >234 && Iac<=261){wireinv=150,vd=0.00041}
                    else if(Iac >261 && Iac<=297){wireinv=185,vd=0.00036}
                    else if(Iac >297 && Iac<=348){wireinv=240,vd=0.0003}
                    else if(Iac >348 && Iac<=398){wireinv=300,vd=0.00027}
                    else if(Iac >398 && Iac<=475){wireinv=400,vd=0.00025}
                    else if(Iac >475 && Iac<=545){wireinv=500,vd=0.00023}
        }
                else if(wireac == 'thws'){
                    if(Iac<=20){wireinv=2.5 ,vd=0.018}
                    else if(Iac >20 && Iac<=26){wireinv=4 ,vd=0.011}
                    else if(Iac >26 && Iac<=33){wireinv=6,vd=0.0073}
                    else if(Iac >33 && Iac<=45){wireinv=10,vd=0.0044}
                    else if(Iac >45 && Iac<=60){wireinv=16,vd=0.0028}
                    else if(Iac >60 && Iac<=78){wireinv=25,vd=0.00175}
                    else if(Iac >78 && Iac<=97){wireinv=35,vd=0.00125}
                    else if(Iac >97 && Iac<=116){wireinv=50,vd=0.00093}
                    else if(Iac >116 && Iac<=146){wireinv=70,vd=0.00065}
                    else if(Iac >146 && Iac<=175){wireinv=95,vd=0.00049}
                    else if(Iac >175 && Iac<=202){wireinv=120,vd=0.00041}
                    else if(Iac >202 && Iac<=224){wireinv=150,vd=0.00034}
                    else if(Iac >224 && Iac<=256){wireinv=185,vd=0.00029}
                    else if(Iac >256 && Iac<=299){wireinv=240,vd=0.00024}
                    else if(Iac >299 && Iac<=343){wireinv=300,vd=0.00021}
                }
                
                else if(wireac == 'cv'){
                    if(Iac<=28){wireinv=2.5 ,vd=0.019}
                    else if(Iac >28 && Iac<=38){wireinv=4 ,vd=0.012}
                    else if(Iac >38 && Iac<=49){wireinv=6,vd=0.0079}
                    else if(Iac >49 && Iac<=68){wireinv=10,vd=0.0047}
                    else if(Iac >68 && Iac<=91){wireinv=16,vd=0.0029}
                    else if(Iac >91 && Iac<=121){wireinv=25,vd=0.00185}
                    else if(Iac >121 && Iac<=149){wireinv=35,vd=0.00137}
                    else if(Iac >149 && Iac<=180){wireinv=50,vd=0.00104}
                    else if(Iac >180 && Iac<=230){wireinv=70,vd=0.00075}
                    else if(Iac >230 && Iac<=278){wireinv=95,vd=0.00058}
                    else if(Iac >278 && Iac<=322){wireinv=120,vd=0.00049}
                    else if(Iac >322 && Iac<=358){wireinv=150,vd=0.00042}
                    else if(Iac >358 && Iac<=409){wireinv=185,vd=0.00037}
                    else if(Iac >409 && Iac<=480){wireinv=240,vd=0.00032}
                    else if(Iac >480 && Iac<=549){wireinv=300,vd=0.00028}
                    else if(Iac >549 && Iac<=622){wireinv=400,vd=0.00025}
                    else if(Iac >622 && Iac<=713){wireinv=500,vd=0.00023}
        }
        
                else if(wireac == 'cvs'){
                    if(Iac<=27){wireinv=2.5 ,vd=0.019}
                    else if(Iac >27 && Iac<=36){wireinv=4 ,vd=0.012}
                    else if(Iac >36 && Iac<=46){wireinv=6,vd=0.0079}
                    else if(Iac >46 && Iac<=63){wireinv=10,vd=0.0047}
                    else if(Iac >63 && Iac<=83){wireinv=16,vd=0.0029}
                    else if(Iac >83 && Iac<=108){wireinv=25,vd=0.00185}
                    else if(Iac >108 && Iac<=133){wireinv=35,vd=0.00135}
                    else if(Iac >133 && Iac<=159){wireinv=50,vd=0.00099}
                    else if(Iac >159 && Iac<=201){wireinv=70,vd=0.00068}
                    else if(Iac >201 && Iac<=241){wireinv=95,vd=0.00052}
                    else if(Iac >241 && Iac<=278){wireinv=120,vd=0.00042}
                    else if(Iac >278 && Iac<=304){wireinv=150,vd=0.00035}
                    else if(Iac >304 && Iac<=349){wireinv=185,vd=0.0003}
                    else if(Iac >349 && Iac<=418){wireinv=240,vd=0.00024}
                    else if(Iac >418 && Iac<=484){wireinv=300,vd=0.00021}
        }
        
                
                Vdrop_ac= vd*datain.Iinv_acmax*$('#Inv_Mdb').val()
                Per_vdropac = (100/230)*Vdrop_ac
                Ploss_ac = datain.Iinv_acmax*Vdrop_ac
                Per_plossac = (100*Ploss_ac/datain.Pinv_ac)
        })}) 
        $(document).ready(function() {
            $('.form-control').click(function(){ 
                wireac = $('#wireac').val()
...
$(document).ready(function() {
    $('.form-control').keyup(function(){    
        if(wireac == 'thw'){
            if(cbact<=21){wireinv2=2.5 ,vd=0.018}
            else if(cbact >21 && cbact<=28){wireinv2=4 ,vd=0.011}
            else if(cbact >28 && cbact<=36){wireinv2=6,vd=0.0073}
            else if(cbact >36 && cbact<=50){wireinv2=10,vd=0.0044}
            else if(cbact >50 && cbact<=66){wireinv2=16,vd=0.0028}
            else if(cbact >66 && cbact<=88){wireinv2=25,vd=0.00181}
            else if(cbact >88 && cbact<=109){wireinv2=35,vd=0.00133}
            else if(cbact >109 && cbact<=131){wireinv2=50,vd=0.001}
            else if(cbact >131 && cbact<=167){wireinv2=70,vd=0.00071}
            else if(cbact >167 && cbact<=202){wireinv2=95,vd=0.00056}
            else if(cbact >202 && cbact<=234){wireinv2=120,vd=0.00048}
            else if(cbact >234 && cbact<=261){wireinv2=150,vd=0.00041}
            else if(cbact >261 && cbact<=297){wireinv2=185,vd=0.00036}
            else if(cbact >297 && cbact<=348){wireinv2=240,vd=0.0003}
            else if(cbact >348 && cbact<=398){wireinv2=300,vd=0.00027}
            else if(cbact >398 && cbact<=475){wireinv2=400,vd=0.00025}
            else if(cbact >475 && cbact<=545){wireinv2=500,vd=0.00023}
}      
        else if(wireac == 'thws'){
            if(cbact<=20){wireinv2=2.5 ,vd=0.018}
            else if(cbact >20 && cbact<=26){wireinv2=4 ,vd=0.011}
            else if(cbact >26 && cbact<=33){wireinv2=6,vd=0.0073}
            else if(cbact >33 && cbact<=45){wireinv2=10,vd=0.0044}
            else if(cbact >45 && cbact<=60){wireinv2=16,vd=0.0028}
            else if(cbact >60 && cbact<=78){wireinv2=25,vd=0.00175}
            else if(cbact >78 && cbact<=97){wireinv2=35,vd=0.00125}
            else if(cbact >97 && cbact<=116){wireinv2=50,vd=0.00093}
            else if(cbact >116 && cbact<=146){wireinv2=70,vd=0.00065}
            else if(cbact >146 && cbact<=175){wireinv2=95,vd=0.00049}
            else if(cbact >175 && cbact<=202){wireinv2=120,vd=0.00041}
            else if(cbact >202 && cbact<=224){wireinv2=150,vd=0.00034}
            else if(cbact >224 && cbact<=256){wireinv2=185,vd=0.00029}
            else if(cbact >256 && cbact<=299){wireinv2=240,vd=0.00024}
            else if(cbact >299 && cbact<=343){wireinv2=300,vd=0.00021}
}
        else if(wireac == 'cv'){
            ...
            if(cbact<=27){wireinv2=2.5 ,vd=0.019}
            else if(cbact >27 && cbact<=36){wireinv2=4 ,vd=0.012}
            else if(cbact >36 && cbact<=46){wireinv2=6,vd=0.0079}
            else if(cbact >46 && cbact<=63){wireinv2=10,vd=0.0047}
            else if(cbact >63 && cbact<=83){wireinv2=16,vd=0.0029}
            else if(cbact >83 && cbact<=108){wireinv2=25,vd=0.00185}
            else if(cbact >108 && cbact<=133){wireinv2=35,vd=0.00135}
            else if(cbact >133 && cbact<=159){wireinv2=50,vd=0.00099}
            else if(cbact >159 && cbact<=201){wireinv2=70,vd=0.00068}
            else if(cbact >201 && cbact<=241){wireinv2=95,vd=0.00052}
            else if(cbact >241 && cbact<=278){wireinv2=120,vd=0.00042}
            else if(cbact >278 && cbact<=304){wireinv2=150,vd=0.00035}
            else if(cbact >304 && cbact<=349){wireinv2=185,vd=0.0003}
            else if(cbact >349 && cbact<=418){wireinv2=240,vd=0.00024}
            else if(cbact >418 && cbact<=484){wireinv2=300,vd=0.00021}
}
    })})      
    $(document).ready(function() {
        $('.form-control').click(function(){    
...
$(document).ready(function() {
    ...
    $(document).ready(function() {
        $('.form-control').click(function(){
            ...
            Ploss_pv1fs1 = Vdrop_pv1fs1*data.Imp
...
$(document).ready(function() {
    $('.form-control').click(function(){
        if(metdc==1){pipe = areatotaldc/0.4}
        else if(metdc==2){pipe = areatotaldc/0.2}
        $('#pipe_way1').val(pipe.toFixed(2))
    })})   
    $(document).ready(function() {
        $('.form-control').keyup(function(){
            if(metdc==1){pipe = areatotaldc/0.4}
    ...
    $(document).ready(function() {
        $('.form-control').click(function(){ 
            ...
            if(wireac == 'thw'){
                ...
                else if(Iacs1 >545){wireinvs1=500}
    }
            else if(wireac == 'thws'){
                ...
                else if(Iacs1 >343){wireinvs1=300}
            }
                ...
                else if(Iacs1 >713){wireinvs1=500}
    }
                ...
                else if(Iacs1 >484){wireinvs1=300}
    }
...
$('#wire_invs').val(wireinvs1)
    ...
    $(document).ready(function() {
        ...
        if(wireac == 'thw'){
            ...
            else if(wireacs2==2.5){vd=0.018}//, areawireac=11.94
            else if(wireacs2==4){vd=0.011}//, areawireac=15.21
            else if(wireacs2==6){vd=0.0073}//, areawireac=19.63
            else if(wireacs2==10){vd=0.0044}//, areawireac=32.17
            else if(wireacs2==16){vd=0.0028}
            else if(wireacs2==25){vd=0.00181}
            else if(wireacs2==35){vd=0.00133}
            else if(wireacs2==50){vd=0.001}
            else if(wireacs2==70){vd=0.00071}
            else if(wireacs2==95){vd=0.00056}
            else if(wireacs2==120){vd=0.00048}
            else if(wireacs2==150){vd=0.00041}
            else if(wireacs2==185){vd=0.00036}
            else if(wireacs2==240){vd=0.0003}
            else if(wireacs2==300){vd=0.00027}
            else if(wireacs2==400){vd=0.00025}
            else if(wireacs2==500){vd=0.00023}
}
        else if(wireac == 'thws'){
            if(wireacs2==0){vd=0}
            else if(wireacs2==2.5){vd=0.018}
            else if(wireacs2==4){vd=0.011}
            else if(wireacs2==6){vd=0.0073}
            else if(wireacs2==10){vd=0.0044}
            else if(wireacs2==16){vd=0.0028}
            else if(wireacs2==25){vd=0.00175}
            else if(wireacs2==35){vd=0.00125}
            else if(wireacs2==50){vd=0.00093}
            else if(wireacs2==70){vd=0.00065}
            else if(wireacs2==95){vd=0.00049}
            else if(wireacs2==120){vd=0.00041}
            else if(wireacs2==150){vd=0.00034}
            else if(wireacs2==185){vd=0.00029}
            else if(wireacs2==240){vd=0.00024}
            else if(wireacs2==300){vd=0.00021}
        }
        
        else if(wireac == 'cv'){
            if(wireacs2==0){vd=0}
            else if(wireacs2==2.5){vd=0.019}
            else if(wireacs2==4){vd=0.012}
            else if(wireacs2==6){vd=0.0079}
            else if(wireacs2==10){vd=0.0047}
            else if(wireacs2==16){vd=0.0029}
            else if(wireacs2==25){vd=0.00185}
            else if(wireacs2==35){vd=0.00137}
            else if(wireacs2==50){vd=0.00104}
            else if(wireacs2==70){vd=0.00075}
            else if(wireacs2==95){vd=0.00058}
            else if(wireacs2==120){vd=0.00049}
            else if(wireacs2==150){vd=0.00042}
            else if(wireacs2==185){vd=0.00037}
            else if(wireacs2==240){vd=0.00032}
            else if(wireacs2==300){vd=0.00028}
            else if(wireacs2==400){vd=0.00025}
            else if(wireacs2==500){vd=0.00023}
}
            ...
            else if(wireacs2==35){vd=0.00135}
            else if(wireacs2==50){vd=0.00099}
            else if(wireacs2==70){vd=0.00068}
            else if(wireacs2==95){vd=0.00052}
            else if(wireacs2==120){vd=0.00042}
            else if(wireacs2==150){vd=0.00035}
            else if(wireacs2==185){vd=0.0003}
            else if(wireacs2==240){vd=0.00024}
            else if(wireacs2==300){vd=0.00021}
}
